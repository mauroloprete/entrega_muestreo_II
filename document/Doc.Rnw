...
set_names(
  ...
  kbl(
  booktabs = TRUE,
  caption = "Estimación de la tasa de pobreza usando último Conglomerado a nivel país"
) %>% 
kable_styling(
    latex_options = c(
        "striped",
...
set_names(
  ...
  kbl(
  booktabs = TRUE,
  caption = "Estimación de la tasa de desempleo usando último Conglomerado a nivel país"
) %>% 
kable_styling(
    latex_options = c(
        "striped",
...
set_names(
  ...
  kbl(
  booktabs = TRUE,
  caption = "Estimación del ingreso promedio usando último Conglomerado a nivel país"
) %>% 
kable_styling(
    latex_options = c(
        "striped",
...
set_names(
  ...
  kbl(
  booktabs = TRUE,
  caption = "Estimación de la tasa de desempleo usando Boostrap Rao-Wu a nivel país"
) %>% 
kable_styling(
    latex_options = c(
        "striped",
...
set_names(
  ...
  kbl(
  booktabs = TRUE,
  caption = "Estimación del ingreso promedio usando Boostrap Rao-Wu a nivel país"
) %>% 
kable_styling(
    latex_options = c(
        "striped",
...
set_names(
  ...
  kbl(
  booktabs = TRUE,
  caption = "Estimación de la tasa de pobreza usando Boostrap Rao-Wu a nivel país"
) %>% 
kable_styling(
    latex_options = c(
        "striped",
...
Por otra parte, cuando se analiza la variabilidad de las estimaciones haciendo uso del desvío estancar, puede verse como ambos métodos mantienen (en muy pocos conglomerados) diferencias mínimas, de una 0.001 como máximo.
\\
